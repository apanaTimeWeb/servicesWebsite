      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {stats.map((stat, index) => (
            <Card key={index} className="text-center border-border/50 hover:border-primary/20 transition-colors">
              <CardContent className="p-8">
                ...
                <div className="text-3xl font-bold text-foreground mb-2 font-[family-name:var(--font-space-grotesk)]">
                  {stat.number}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <Card className="border-border/50">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold mb-6 font-[family-name:var(--font-space-grotesk)] flex items-center">
