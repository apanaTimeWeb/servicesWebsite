    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="relative flex items-center justify-center">
                  {/* vertical connector from node to central line */}
                  <div
                    className={
                      isTop
          ...
          {/* Mobile: horizontal stepper with scroll */}
        ...
        <div className="text-center mt-32">
          <Card className="inline-block border-primary/20 bg-primary/5">
            <CardContent className="p-6">
              <h4 className="text-lg font-semibold mb-2 font-[family-name:var(--font-space-grotesk)]">
