...
import { SiTensorflow, SiPytorch, SiScikitlearn, SiPython } from "react-icons/si"
...
export default function MLPrediction() {
  ...
  const technologies = [
    { name: "TensorFlow & PyTorch", desc: "Industry-leading ML frameworks", icon: SiTensorflow },
    { name: "Scikit-learn", desc: "Classical machine learning algorithms", icon: SiScikitlearn },
    { name: "XGBoost & LightGBM", desc: "Gradient boosting for high accuracy", icon: FaChartLine },
    { name: "Time Series Analysis", desc: "ARIMA, Prophet for forecasting", icon: MdShowChart },
    { name: "Deep Learning", desc: "Neural networks for complex patterns", icon: FaBrain },
  ...
  const cases = caseStudies.mlPrediction
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ textAlign: 'center', maxWidth: '56rem', margin: '0 auto' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', padding: '0.5rem 1rem', border: '1px solid #3b82f6', borderRadius: '9999px', marginBottom: '1rem', color: '#3b82f6', animation: 'fadeInUp 0.6s ease-out' }}>
              <IoMdTrendingUp style={{ width: '1rem', height: '1rem', marginRight: '0.5rem' }} />
