export const projects = {
  web: [
    { name: "Library Management System", desc: "Book tracking, member management, issue/return system; 5k+ books managed" },
    { name: "PG Management Portal", desc: "Room allocation, bed management, rent tracking; 200+ rooms" },
    { name: "Gym Management System", desc: "Member subscriptions, trainer scheduling, equipment tracking" },
    { name: "Hospital Management", desc: "Patient records, appointment booking, billing system" },
    { name: "School Management ERP", desc: "Student records, attendance, fee management, results" },
    { name: "Restaurant POS System", desc: "Order management, billing, inventory, table booking" },
    { name: "E-commerce Platform", desc: "Product catalog, cart, payment gateway, order tracking; 10k+ products" },
...
export const testimonials = {
  web: [
    { quote: "The library management system has streamlined our entire operation. Book tracking is now effortless!", author: "Rajesh Kumar", company: "City Central Library, Delhi", rating: 5 },
    { quote: "Our PG management became so easy with their portal. Rent collection and room allocation are automated now.", author: "Priya Sharma", company: "Student PG Services, Mumbai", rating: 4.5 },
    { quote: "The gym management system helped us grow from 100 to 500+ members. Excellent work!", author: "Amit Patel", company: "FitZone Gym, Bangalore", rating: 5 },
    { quote: "Hospital management system reduced our paperwork by 80%. Highly recommended!", author: "Dr. Sunil Reddy", company: "Care Hospital, Hyderabad", rating: 4 },
